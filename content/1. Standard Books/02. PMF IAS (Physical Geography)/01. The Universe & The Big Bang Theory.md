...
> **Credits & Source → Chapter 01 @ PMF IAS (Physical Geography)**
...
1.  **Nebula** = Gas & dust cloud (primarily **H & He**); birthplaces of stars.
2.  **Protostar** = Early star; nuclear fusion **not yet active** (luminosity solely from **gravitational contraction heating**).
...
3.  **T Tauri Star** = Young, gravity-contracting star; intermediate stage between Protostar and low-mass main sequence star.
4.  **Main Sequence Star** = Stable star with core nuclear fusion in full swing (e.g., **Sun**).
5.  **Branching Life-Cycle Paths**:
