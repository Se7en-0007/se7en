...
├────────────────────────────────────┬────────────────────────────────────┤
│         Western Lens (Monaghan)    │        Mixtec Lens (Villagers)     │
├────────────────────────────────────┼────────────────────────────────────┤
│ - Bee Larvae: Raw, wriggling and  │ - Bee Larvae: Exquisite, natural,  │
│   physically repulsive.            │   and nutrient-dense delicacy.     │
├────────────────────────────────────┼────────────────────────────────────┤
│ - Onion Soup: Warm, comforting,    │ - Onion Soup: Foul-smelling;       │
│   and culturally standard meal.    │   "Onions make a person stupid."   │
└────────────────────────────────────┴────────────────────────────────────┘
```
...
```
       [ GREEK ETYMOLOGY ]
         - Anthropos: Human / Humankind
         - Logos: Systematic / Scientific Study
                         │
                         ▼
       [ ETYMO-DEFINITIONAL SYNTHESIS ]
         - The holistic study of human biological, social and cultural 
           diversity across all temporal and spatial dimensions.
```
...
```
         ...
         ┌──────────────────┬───────┴──────────┬──────────────────┐
         ▼                  ▼                  ▼                  ▼
  [ Socio-Cultural ]  [ Biological ]     [ Linguistic ]    [ Archaeological ]
   - Society          - Primatological    - Structural      - Paleolithic
   - Culture          - Genetic           - Sociolinguistic - Mesolithic
   - Stratification   - Adaptive          - Historical      - Neolithic
```
...
```
   ┌─────────────────────────────────────────────────────────────┐
   │                  THE ANATOMICAL OF HOLISM                   │
   ├─────────────────────────────────────────────────────────────┤
   │ - Biological Analogy: You cannot study the Kidneys     │
   │   without understanding the Heart that pumps blood     │
   │   through them.                                        │
   ├─────────────────────────────────────────────────────────────┤
   │ - Anthropological Reality: You cannot study Human Biology  │
   │   in isolation from Human Culture, as each continually      │
   │   shapes and adapts to the other.                 │
   └─────────────────────────────────────────────────────────────┘
```
...
```
      ...
      └─────────────────────────────┬──────────────────────────────┘
         ...
         ┌──────────────────────────┼──────────────────────────┐
         ▼                          ▼                          ▼
   [ Linguistics ]            [ Archaeology ]            [ Sociology ]
   - Studies syntax,          - Studies past material    - Focuses on modern,
     grammar and phonetics     remains in isolation       complex, often
     in isolation.              from biology.              Western societies.
         │                          │                          │
         ▼                          ▼                          ▼
 [ Linguistic Anth ]        [ Arch Anth ]              [ Socio-Cultural Anth ]
   - Integrates syntax with   - Links tool production    - Employs participant
     social power, gender,      with biological hand       observation to study
     and biological evolution.  adaptations and ecology.   diverse global cultures.
```
...
├────────────────────────────────────────────────────────────────────────┤
│ 3. ANTHROPOLOGICAL THOUGHTS & THEORIES (Unit 6 & 8)                    │
